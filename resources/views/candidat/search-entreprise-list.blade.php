					...
					<div class="col-md-12 mb-3">
						<div class="layout-switcher-wrap">
							...
							<div class="layout-switcher">
								<ul>
									<li><a href="search-with-sidebar-2.html"><i class="ti-layout-grid3"></i></a></li>
									<li class="active"><a href="search-with-sidebar-list-2.html"><i class="ti-view-list"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						...
						<div class="verticle-job-modern">
							...
							<div class="verticle-job-top-capt">
								<div class="vjt-left-cmp">
									...
									<div class="vjt-cmp-title">
										<h4 class="jmg-title"><a href="job-detail.html">iPhone Developer</a></h4>
										<h6 class="vjt-company-title"><a href="#">Safari</a></h6>
									</div>
								</div>
								<div class="vjt-right-cmp">
						...
						<div class="verticle-job-modern">
							...
							<div class="verticle-job-top-capt">
								<div class="vjt-left-cmp">
									<div class="vjt-cmp-thumb">
										<a href="job-detail.html"><img src="assets/img/bing.png" alt="" /></a>
									</div>
									<div class="vjt-cmp-title">
										<h4 class="jmg-title"><a href="job-detail.html">Magento Developer</a></h4>
										<h6 class="vjt-company-title"><a href="#">Bing Inc.</a></h6>
									</div>
								</div>
								<div class="vjt-right-cmp">
									<h4 class="jmg-sallery">$1300 - $1700 PLN</h4>
								</div>
							</div>
							...
							<div class="verticle-job-bottom-capt">
								...
								<div class="vjt-metainfo">
									<span><i class="ti-location-pin"></i>Newzeland</span>
									<span><i class="ti-briefcase"></i>Contract</span>
									<span><i class="ti-calendar"></i>March 10, 2020</span>
								</div>
							</div>
						...
						<div class="verticle-job-modern">
							...
							<div class="verticle-job-top-capt">
								<div class="vjt-left-cmp">
									<div class="vjt-cmp-thumb">
										<a href="job-detail.html"><img src="assets/img/yelp.png" alt="" /></a>
									</div>
									<div class="vjt-cmp-title">
										<h4 class="jmg-title"><a href="job-detail.html">Logo Designer</a></h4>
										<h6 class="vjt-company-title"><a href="#">Yelp Ltd</a></h6>
									</div>
								</div>
								<div class="vjt-right-cmp">
									<h4 class="jmg-sallery">$1600 - $2000 PLN</h4>
								</div>
							</div>
							...
							<div class="verticle-job-bottom-capt">
								...
								<div class="vjt-metainfo">
									<span><i class="ti-location-pin"></i>London</span>
									<span><i class="ti-briefcase"></i>Part Time</span>
									<span><i class="ti-calendar"></i>Jan 10, 2020</span>
								</div>
							</div>
						...
						<div class="verticle-job-modern">
							...
							<div class="verticle-job-top-capt">
								<div class="vjt-left-cmp">
									...
									<div class="vjt-cmp-title">
										<h4 class="jmg-title"><a href="job-detail.html">Team Managing</a></h4>
										<h6 class="vjt-company-title"><a href="#">Asana</a></h6>
									</div>
								</div>
								<div class="vjt-right-cmp">
									<h4 class="jmg-sallery">$1700 - $3200 PLN</h4>
								</div>
							</div>
							...
							<div class="verticle-job-bottom-capt">
								...
								<div class="vjt-metainfo">
									<span><i class="ti-location-pin"></i>Australia</span>
									<span><i class="ti-briefcase"></i>Full Time</span>
									<span><i class="ti-calendar"></i>Jan 10, 2020</span>
								</div>
							</div>
						...
						<div class="verticle-job-modern">
							...
							<div class="verticle-job-top-capt">
								<div class="vjt-left-cmp">
									...
									<div class="vjt-cmp-title">
										...
										<h6 class="vjt-company-title"><a href="#">PayPal</a></h6>
									</div>
								</div>
								<div class="vjt-right-cmp">
									<h4 class="jmg-sallery">$1000 - $1200 PLN</h4>
								</div>
							</div>
							...
							<div class="verticle-job-bottom-capt">
								...
								<div class="vjt-metainfo">
									<span><i class="ti-location-pin"></i>Norway</span>
									<span><i class="ti-briefcase"></i>Full Time</span>
									<span><i class="ti-calendar"></i>Feb 10, 2020</span>
								</div>
							</div>
						...
						<div class="verticle-job-modern">
							...
							<div class="verticle-job-top-capt">
								<div class="vjt-left-cmp">
									...
									<div class="vjt-cmp-title">
										<h4 class="jmg-title"><a href="job-detail.html">UI/UX Designer</a></h4>
										<h6 class="vjt-company-title"><a href="#">Dribbble</a></h6>
									</div>
								</div>
								<div class="vjt-right-cmp">
									<h4 class="jmg-sallery">$1300 - $1600 PLN</h4>
								</div>
							</div>
							...
							<div class="verticle-job-bottom-capt">
								...
								<div class="vjt-metainfo">
									<span><i class="ti-location-pin"></i>Germany</span>
									<span><i class="ti-briefcase"></i>Part Time</span>
									<span><i class="ti-calendar"></i>Jan 12, 2020</span>
								</div>
							</div>
