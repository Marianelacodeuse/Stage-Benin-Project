					...
					<div class="col-md-4 col-sm-12">
						<div class="dashboard-wrap">
							...
							<a class="nav-link" data-toggle="tab" href="#package"><i class="lni-tag"></i>Package</a>
								...
								<li class="nav-item">
									<a class="nav-link" href="{{route('detail-entreprise')}}"><i class="lni-user"></i>View Profile</a>
								</li>
								<li class="nav-item">
						...
						<div class="tab-content">
												...
												<div class="manage-list">
													...
													<div class="mg-list-wrap">
														...
														<div class="mg-list-caption">
															...
															<span><em>Last Update</em> {{$post->update_at}} <em>Creer il y </em></span>
							...
							<div class="tab-pane" id="post-new-job">
								...
								<form action="{{route('create-post')}}" method="POST">
											...
											<div class="row">
												...
												<div class="col-lg-12 col-md-12 col-sm-12">
													<div class="form-group">
														...
														<input class="form-control" type="text" value="Web Designer" name="title">
													</div>
												</div>
									...
									<!-- <a  type="submit" class="btn btn-info btn-md full-width">Save & Update<i class="ml-2 ti-arrow-right"></i></a> -->
									<!-- TEST BY ADDING AN CUSTOM TEXT RICH -->
								</form>
