...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{asset('assets/customs_vendor/css/pages/page-auth.css')}}" />
    <!-- Helpers -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">StageBenin</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Bienvenue sur StageBenin👋</h4>
                        <p class="mb-4">Connectez-vous chère Administrateur</p>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Entrer votre adresse mail" autofocus />
                                @error('email')
                            ...
                            <div class="mt-5">
								<button type="submit" class="btn btn-primary btn-lg d-grid w-100">Connexion</button>
							</div>
                        </form>
